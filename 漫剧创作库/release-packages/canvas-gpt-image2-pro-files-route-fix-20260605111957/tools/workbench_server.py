...
def coerce_gpt_image_2_pro_model_config(data: dict, config_id: str = "") -> dict:
    ...
    return {
        **data,
        ...
        "provider": {**provider, "adapter": "openai-edits", "endpointPath": "/images/edits", "uploadMode": "files"},
        "protocol": {**protocol, "adapter": "openai-edits", "endpointPath": "/images/edits", "uploadMode": "files", "upload_mode": "files", "method": protocol.get("method") or "sync"},
    }
