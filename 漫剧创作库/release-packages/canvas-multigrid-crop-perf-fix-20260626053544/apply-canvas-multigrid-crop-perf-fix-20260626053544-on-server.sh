...
WORKDIR="$(mktemp -d)"
BACKUP_DIR="/home/ubuntu/漫剧创作库/.deploy-backups/canvas-multigrid-crop-perf-fix-20260626053544-${STAMP}"
...
echo "deployed canvas-multigrid-crop-perf-fix-20260626053544"
