...
PKG="storyboard-toolbar-width-110-20260607034058"
...
verify_markers(){
  ...
  grep -Fq "width*nodeToolbarMinWidthScale(bar)" "$file"
...
verify_markers_sudo(){
  ...
  run_sudo grep -Fq "width*nodeToolbarMinWidthScale(bar)" "$file"
