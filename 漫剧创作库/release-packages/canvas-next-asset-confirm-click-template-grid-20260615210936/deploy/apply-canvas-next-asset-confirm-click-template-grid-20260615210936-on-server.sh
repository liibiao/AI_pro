...
PKG="canvas-next-asset-confirm-click-template-grid-20260615210936"
...
for marker in \
  ...
  "renderAssetCardTemplatePicker({...card,type,templateId:template.id},'editor')" \
  "addEventListener('pointerup',e=>" \
  "asset-confirm-editor-meta .asset-card-template-menu"
do
