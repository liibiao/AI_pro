...
PKG="canvas-progress-card-center-scale-20260604152553"
...
verify_markers(){
  ...
  grep -Fq -- "transform:translate(-50%,-50%)!important;" "$dest"
  grep -Fq -- "box-sizing:border-box!important;" "$dest"
  grep -Fq -- "max-width:68%!important;" "$dest"
  grep -Fq -- "min-width:76px!important;" "$dest"
  grep -Fq -- "min-height:49px!important;" "$dest"
  grep -Fq -- "font-size:20px!important;" "$dest"
  grep -Fq -- "line-height:normal!important;" "$dest"
  grep -Fq -- "min-width:55px!important;" "$dest"
  grep -Fq -- ".node.node-type-storyboardImage .storygrid-panel .storygrid-shot-progress-inner b{font-size:15px!important}" "$dest"
