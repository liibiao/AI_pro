...
PKG="prompt-ref-control-real-i2i-fix-20260601012741"
...
log "verify markers"
grep -q "bindPromptZoomReferenceAreas" "$DEST"
grep -q "promptImportFileExt" "$DEST"
grep -q "prompt-ref-area.ref-open" "$DEST"
grep -q "isPromptImportImageFile" "$DEST"
