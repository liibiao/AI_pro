...
function hasStrongVideoModelSignal(model={},adapter='',endpoint=''){
  ...
  return ['fullblood-video','sd2-internal','lingdong-sd-2-vip','sd-2-vip','zaomeng-seedance2','zaomeng-seedance2-svip','zaomeng-seedance2-fast','sora-video-pro','seedance2','seedance2.0','aiyunzhi-grok-video','aiyunzhi-veo-video'].includes(adapter)||
