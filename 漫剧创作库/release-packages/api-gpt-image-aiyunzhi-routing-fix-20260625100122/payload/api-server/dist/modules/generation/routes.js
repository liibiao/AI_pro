...
function resolveGenerationAdapterName(provider, model) {
    ...
    if (configuredLower === 'aiyunzhi-gpt-image-2')
        return 'aiyunzhi-gpt-image-2';
    if (hint.includes('aiyunzhi-gpt-image-2-api') || hint.includes('canvas-aiyunzhi-gpt-image-2-api') || hint.includes('canvas_aiyunzhi-gpt-image-2-api'))
        return 'aiyunzhi-gpt-image-2';
