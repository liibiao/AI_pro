...
PKG="canvas-next-asset-confirm-drag-exclude-20260615233655"
...
for marker in \
  ".shot-storyboard-local-bar,.asset-confirm-node,.asset-confirm-card,.asset-confirm-detail,.asset-confirm-side,.asset-confirm-bar,.vn2-main" \
  "function bindAssetConfirmEditorTemplatePicker" \
  "data-editor-template-picker-host"
do
