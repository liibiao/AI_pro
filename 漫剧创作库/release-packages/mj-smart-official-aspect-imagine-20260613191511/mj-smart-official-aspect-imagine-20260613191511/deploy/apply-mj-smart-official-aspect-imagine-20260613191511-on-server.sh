...
PKG="mj-smart-official-aspect-imagine-20260613191511"
...
verify_backend_markers_sudo(){ local file="$1"; run_sudo grep -Fq "_sanitize_midjourney_prompt_for_version" "$file"; run_sudo grep -Fq "_strip_midjourney_flag_param" "$file"; run_sudo grep -Fq "prompt_urls_to_prefix" "$file"; run_sudo grep -Fq -- "--oref {cref_url} --ow 100" "$file"; }
