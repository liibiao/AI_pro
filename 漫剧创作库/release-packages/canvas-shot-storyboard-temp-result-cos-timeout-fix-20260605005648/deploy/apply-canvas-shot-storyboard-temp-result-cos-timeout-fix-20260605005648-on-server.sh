...
PKG="canvas-shot-storyboard-temp-result-cos-timeout-fix-20260605005648"
...
verify_canvas_markers(){
  ...
  grep -Fq "function isTemporaryGenerationResultUrl" "$file"
...
verify_canvas_markers_sudo(){
  ...
  run_sudo grep -Fq "function isTemporaryGenerationResultUrl" "$file"
