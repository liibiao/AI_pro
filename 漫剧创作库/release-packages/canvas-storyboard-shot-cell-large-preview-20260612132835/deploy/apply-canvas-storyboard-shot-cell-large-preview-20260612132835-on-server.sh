...
PKG="canvas-storyboard-shot-cell-large-preview-20260612132835"
...
verify_html_markers_sudo(){
  local file="$1"
  run_sudo grep -Fq 'storygrid-panel-large' "$file"
  ...
  run_sudo grep -Fq 'function toggleStoryboardShotSelection(nOrId,shotNo)' "$file"
