...
PKG="panorama-preview-drag-toolbar-fix-20260603213905"
...
grep -Fq "panorama-preview-drag-toolbar-fix" "$SRC/workbench-web/image-studio-canvas-next.html"
grep -Fq "canvas.style.opacity='0'" "$SRC/workbench-web/image-studio-canvas-next.html"
grep -Fq "[data-pano-drag],.pano-drag-hotspot" "$SRC/workbench-web/image-studio-canvas-next.html"
grep -Fq "pano-gen-layout>.pano-gen-bar" "$SRC/workbench-web/canvas-next/tapnow-rewrite.css"
grep -Fq "pano-node-fallback-img" "$SRC/workbench-web/canvas-next/tapnow-rewrite.css"
...
if [ -f "$WORKBENCH_DIR/image-studio-canvas-next.html" ]; then
  run_sudo grep -Fq "panorama-preview-drag-toolbar-fix" "$WORKBENCH_DIR/image-studio-canvas-next.html"
  run_sudo grep -Fq "[data-pano-drag],.pano-drag-hotspot" "$WORKBENCH_DIR/image-studio-canvas-next.html"
fi
if [ -f "$WORKBENCH_DIR/canvas-next/tapnow-rewrite.css" ]; then
  run_sudo grep -Fq "pano-gen-layout>.pano-gen-bar" "$WORKBENCH_DIR/canvas-next/tapnow-rewrite.css"
fi
if [ -f "$MIRROR_TARGET/tools/workbench-web/image-studio-canvas-next.html" ]; then
  run_sudo grep -Fq "panorama-preview-drag-toolbar-fix" "$MIRROR_TARGET/tools/workbench-web/image-studio-canvas-next.html"
  run_sudo grep -Fq "[data-pano-drag],.pano-drag-hotspot" "$MIRROR_TARGET/tools/workbench-web/image-studio-canvas-next.html"
fi
if [ -f "$MIRROR_TARGET/tools/workbench-web/canvas-next/tapnow-rewrite.css" ]; then
  run_sudo grep -Fq "pano-gen-layout>.pano-gen-bar" "$MIRROR_TARGET/tools/workbench-web/canvas-next/tapnow-rewrite.css"
fi
