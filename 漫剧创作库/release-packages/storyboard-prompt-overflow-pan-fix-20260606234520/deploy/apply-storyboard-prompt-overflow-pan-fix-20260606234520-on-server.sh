...
PKG="storyboard-prompt-overflow-pan-fix-20260606234520"
...
verify_markers(){
  ...
  grep -Fq "overflow-y:auto!important;" "$file"
  grep -Fq "overflow-x:hidden!important;" "$file"
  grep -Fq "contain:paint!important;" "$file"
  grep -Fq ".storyboard-rich-box>.i2i-text-input" "$file"
...
verify_markers_sudo(){
  ...
  run_sudo grep -Fq "overflow-y:auto!important;" "$file"
  run_sudo grep -Fq "overflow-x:hidden!important;" "$file"
  run_sudo grep -Fq "contain:paint!important;" "$file"
  run_sudo grep -Fq ".storyboard-rich-box>.i2i-text-input" "$file"
