...
WORKDIR="$(mktemp -d)"
BACKUP_DIR="/home/ubuntu/漫剧创作库/.deploy-backups/asset-confirm-runtime-derive-ui-fix-20260617134726-${STAMP}"
...
echo "deployed asset-confirm-runtime-derive-ui-fix-20260617134726"
