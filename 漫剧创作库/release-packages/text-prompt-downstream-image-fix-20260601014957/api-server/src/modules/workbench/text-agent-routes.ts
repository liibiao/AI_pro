...
async function runLlm(modelKey = '', prompt: string, body?: z.infer<typeof textAgentSchema>) {
...
function buildUserMessageContent(prompt: string, body?: z.infer<typeof textAgentSchema>) {
...
function normalizeTextAgentMediaUrls(body: z.infer<typeof textAgentSchema>, req: any) {
