...
function resolveAiyunzhiGptImage2Size(ctx) {
    ...
    if (!['1K', '2K', '4K'].includes(resolution)) {
        fail(400, `Aiyunzhi GPT Image 2 只支持 size=1k、2k、4k，当前为 ${String(resolution || '').trim() || '空'}`, 'AIYUNZHI_GPT_IMAGE2_SIZE_UNSUPPORTED');
    }
