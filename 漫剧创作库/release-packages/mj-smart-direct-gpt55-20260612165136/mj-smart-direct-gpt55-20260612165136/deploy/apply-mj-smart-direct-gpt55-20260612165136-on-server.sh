#!/usr/bin/env bash
set -Eeuo pipefail
PKG_NAME="mj-smart-direct-gpt55-20260612165136"
ARCHIVE="${1:-}"
...
log "verify markers"
grep -q "findSmartMidjourneyLlmModel" "$PUBLIC_ROOT/workbench-web/image-studio-canvas-next.html"
grep -q "CanvasAccountGate.chat" "$PUBLIC_ROOT/workbench-web/image-studio-canvas-next.html"
grep -q "agentTask:'smart-midjourney-prompt'" "$PUBLIC_ROOT/workbench-web/image-studio-canvas-next.html"
