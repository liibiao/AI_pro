...
PKG="seedance-video-toolbar-mid-compact-20260607032307"
...
verify_markers(){
  ...
  grep -Fq "height:43px!important;" "$file"
  grep -Fq "gap:5px!important;" "$file"
  grep -Fq "height:22px!important;" "$file"
  grep -Fq "width:103px!important;" "$file"
  grep -Fq "width:39px!important;" "$file"
  grep -Fq "width:31px!important;" "$file"
  grep -Fq "transform:translateX(9px)!important;" "$file"
}
verify_markers_sudo(){
  local file="$1"
  ...
  run_sudo grep -Fq "height:43px!important;" "$file"
  run_sudo grep -Fq "gap:5px!important;" "$file"
  run_sudo grep -Fq "height:22px!important;" "$file"
  run_sudo grep -Fq "width:103px!important;" "$file"
  run_sudo grep -Fq "width:39px!important;" "$file"
  run_sudo grep -Fq "width:31px!important;" "$file"
  run_sudo grep -Fq "transform:translateX(9px)!important;" "$file"
}
