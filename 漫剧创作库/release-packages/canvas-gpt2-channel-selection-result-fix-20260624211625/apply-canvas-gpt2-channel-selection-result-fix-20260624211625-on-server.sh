...
BACKUP_DIR="$APP_ROOT/.deploy-backups/canvas-gpt2-channel-selection-result-fix-20260624211625-$STAMP"
WORK_DIR="$(mktemp -d)"
...
echo "Installed canvas GPT2 channel selection/result fix."
