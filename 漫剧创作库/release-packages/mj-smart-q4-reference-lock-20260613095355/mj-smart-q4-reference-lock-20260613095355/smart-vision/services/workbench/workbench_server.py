...
def run_smart_midjourney_prompt(payload: dict[str, object]) -> dict[str, object]:
    ...
    expected_params = re.sub(r"\s+", " ", f"--ar {selected_aspect} {runtime_command or ('--niji 7 --q 4' if _is_niji_midjourney_model(image_model, image_model_label) else '--v 7 --style raw --q 4')}").strip()
