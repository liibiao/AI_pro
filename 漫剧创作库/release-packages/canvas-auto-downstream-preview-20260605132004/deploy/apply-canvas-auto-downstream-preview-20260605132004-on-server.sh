...
PKG="canvas-auto-downstream-preview-20260605132004"
...
verify_canvas_markers(){
  ...
  grep -Fq "function ensureGeneratedImagePreviewDownstream" "$file"
  grep -Fq "function ensureGeneratedVideoPreviewDownstream" "$file"
  grep -Fq "function ensureShotStoryboardEditDownstream" "$file"
  grep -Fq "ensureGeneratedImagePreviewDownstream(id)" "$file"
  grep -Fq "ensureGeneratedVideoPreviewDownstream(id)" "$file"
