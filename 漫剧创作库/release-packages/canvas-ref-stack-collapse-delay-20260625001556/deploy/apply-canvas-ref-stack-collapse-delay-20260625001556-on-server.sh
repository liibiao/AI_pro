...
BACKUP_DIR="$APP_ROOT/.deploy-backups/canvas-ref-stack-collapse-delay-20260625001556-$STAMP"
WORK_DIR="$(mktemp -d)"
...
require_marker "function referenceStackAreas" "$HTML_SRC"
...
echo "Installed canvas reference-stack collapse delay update."
