...
PKG="mj-toolbar-zoom-row-fix-20260609113116"
...
verify_html_markers(){
  ...
  grep -Fq '.prompt-zoom-large-group :is(.aio-bar,.prompt-node-bar.v3,.vn2-bar).prompt-zoomed-item:has(.mj-toolbar-row)' "$file"
  grep -Fq '.prompt-zoom-unified-group :is(.aio-bar,.prompt-node-bar.v3,.vn2-bar).prompt-zoomed-item:has(.mj-toolbar-row)' "$file"
  grep -Fq '.prompt-zoom-native-group :is(.aio-bar,.prompt-node-bar.v3,.vn2-bar).prompt-zoomed-item:has(.mj-toolbar-row)' "$file"
...
verify_html_markers_sudo(){
  ...
  run_sudo grep -Fq '.prompt-zoom-large-group :is(.aio-bar,.prompt-node-bar.v3,.vn2-bar).prompt-zoomed-item:has(.mj-toolbar-row)' "$file"
  run_sudo grep -Fq '.prompt-zoom-unified-group :is(.aio-bar,.prompt-node-bar.v3,.vn2-bar).prompt-zoomed-item:has(.mj-toolbar-row)' "$file"
  run_sudo grep -Fq '.prompt-zoom-native-group :is(.aio-bar,.prompt-node-bar.v3,.vn2-bar).prompt-zoomed-item:has(.mj-toolbar-row)' "$file"
