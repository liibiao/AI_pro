...
PKG="canvas-next-asset-confirm-ref-upload-20260616005122"
...
for marker in \
  ...
  "data-asset-confirm-action=\"uploadRef\"" \
  "上传角色形象" \
  "上传道具参考" \
  "上传场景形象" \
  "assetConfirmCleanPromptText" \
  ".asset-template-popover.asset-template-preview-popover{position:fixed;left:0;top:0;z-index:230090"
do
