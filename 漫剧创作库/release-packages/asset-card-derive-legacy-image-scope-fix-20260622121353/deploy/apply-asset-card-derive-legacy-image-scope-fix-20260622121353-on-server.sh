...
WORKDIR="$(mktemp -d)"
BACKUP_DIR="/home/ubuntu/漫剧创作库/.deploy-backups/asset-card-derive-legacy-image-scope-fix-20260622121353-${STAMP}"
...
check_markers(){
  ...
  grep -Fq "image:normalizeImage(card.image||legacyImage||null)" "$file"
...
echo "deployed asset-card-derive-legacy-image-scope-fix-20260622121353"
