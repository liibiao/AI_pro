...
PKG="canvas-toolbar-layout-css-20260606152930"
...
verify_html(){
  local file="$1"
  grep -Fq "tapnow-rewrite.css?v=20260606-toolbar-left-right-layout" "$file"
...
verify_css(){
  ...
  grep -Fq ".vn2-bar-spacer" "$file"
}
verify_html_sudo(){
  local file="$1"
  run_sudo grep -Fq "tapnow-rewrite.css?v=20260606-toolbar-left-right-layout" "$file"
...
verify_css_sudo(){
  ...
  run_sudo grep -Fq ".vn2-bar-spacer" "$file"
}
