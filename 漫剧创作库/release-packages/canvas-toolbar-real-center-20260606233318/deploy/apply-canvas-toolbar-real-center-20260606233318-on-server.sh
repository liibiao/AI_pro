...
PKG="canvas-toolbar-real-center-20260606233318"
...
verify_html(){
  local file="$1"
  grep -Fq "tapnow-rewrite.css?v=20260606-toolbar-center-v2" "$file"
...
verify_html_sudo(){
  local file="$1"
  run_sudo grep -Fq "tapnow-rewrite.css?v=20260606-toolbar-center-v2" "$file"
