...
function isAiyunzhiGptImage2Hint(modelHint: string, hint: string, configuredLower: string) {
  ...
  const isOpenAiEditsGptImage2Variant = text.includes('gpt-image-2-max')
  ...
  if (isOpenAiEditsGptImage2Variant) return false;
  const isAiyunzhiProvider = text.includes('aiyunzhi-gpt-image-2-api')
