...
function resolveAiyunzhiGptImage2Size(ctx) {
    const defaults = isRecord(ctx.model.defaults) ? ctx.model.defaults : {};
    const providerDefaults = isRecord(ctx.provider.defaultParams) ? ctx.provider.defaultParams : {};
    const raw = firstDefined(ctx.params.imageSize, ctx.params.requestedResolution, ctx.params.resolution, defaults.imageSize, defaults.resolution, ctx.params.size, defaults.size, providerDefaults.size, providerDefaults.imageSize, providerDefaults.resolution);
