...
STAMP="20260610012637"
PKG="mj-grid-click-hover-fix-${STAMP}"
TMP="/tmp/${PKG}-extract"
...
for marker in \
  ".node .mj-preview-wrap .mj-grid-cell::after" \
  "border:2px solid rgba(255,80,46,.96)!important" \
  "width:18px!important" \
  "font-size:9px!important" \
  "area.addEventListener('pointerup',openCapturedMj,true)" \
  "area._mjOpenedAt=Date.now()" \
  "[data-mj-preview] [data-mj-cell],[data-mj-preview] [data-mj-page-open]"; do
