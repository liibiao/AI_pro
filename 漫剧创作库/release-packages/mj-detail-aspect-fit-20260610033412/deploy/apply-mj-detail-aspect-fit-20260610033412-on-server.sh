...
STAMP="20260610033412"
PKG="mj-detail-aspect-fit-${STAMP}"
TMP="/tmp/${PKG}-extract"
...
for marker in \
  ".mj-detail-cell-frame{" \
  "aspect-ratio:var(--mj-cell-aspect,1/1)!important" \
  ".mj-detail-cell-frame>.mj-detail-crop{" \
  "function midjourneyDetailCellAspect(page)" \
  "const aspect=midjourneyDetailCellAspect(page)" \
  "style=\"--mj-cell-aspect:\${aspect}\"" \
  "width:grid.width||grid.naturalWidth||grid.imageWidth" \
  "height:grid.height||grid.naturalHeight||grid.imageHeight"; do
