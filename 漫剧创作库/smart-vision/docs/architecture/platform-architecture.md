...
- 本地 `smart-vision/outputs/` 文件系统作为智能视界最终交付物与工程状态源。
- `projects/` 仅作为上游创作项目资料读取源，不作为智能视界运行产物写入目标。
...
```json
{
  "id": "project-id",
  "name": "无限强化·灵纹觉醒",
  "root_path": "smart-vision/outputs",
  "upstream_project_path": "projects/无限强化_漫剧_001",
  "mode": "episode_semi_auto",
  "current_phase": "storyboard",
  "current_episode": "ep001",
  "visual_style_bible": "01-资产图与提示词/style/visual-style-bible.md",
  "status": "running"
}
```
...
```json
{
  ...
  "asset_index_path": "01-资产图与提示词/asset-index.md",
