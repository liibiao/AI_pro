...
PKG_LABEL="admin-generation-report-sql-aggregate"
ARCHIVE="${1:-}"
...
grep -Fq "adminGenerationReportSqlWhere" "$API_SRC"
grep -Fq "aggregateAdminGenerationReportWithSql" "$API_SRC"
grep -Fq "scope: 'range'" "$API_SRC"
...
grep -Fq "adminGenerationReportSqlWhere" "$API_DIST"
grep -Fq "aggregateAdminGenerationReportWithSql" "$API_DIST"
grep -Fq "scope: 'range'" "$API_DIST"
...
run_sudo grep -Fq "adminGenerationReportSqlWhere" "$REMOTE_APP_ROOT/api-server/src/modules/generation/routes.ts"
run_sudo grep -Fq "aggregateAdminGenerationReportWithSql" "$REMOTE_APP_ROOT/api-server/src/modules/generation/routes.ts"
run_sudo grep -Fq "scope: 'range'" "$REMOTE_APP_ROOT/api-server/src/modules/generation/routes.ts"
...
run_sudo grep -Fq "adminGenerationReportSqlWhere" "$REMOTE_APP_ROOT/api-server/dist/modules/generation/routes.js"
run_sudo grep -Fq "aggregateAdminGenerationReportWithSql" "$REMOTE_APP_ROOT/api-server/dist/modules/generation/routes.js"
run_sudo grep -Fq "scope: 'range'" "$REMOTE_APP_ROOT/api-server/dist/modules/generation/routes.js"
...
run_sudo grep -Fq "数据概览" "$REMOTE_APP_ROOT/admin-web/src/main.tsx"
...
run_sudo grep -Rqs "数据概览" "$REMOTE_APP_ROOT/admin-web/dist"
