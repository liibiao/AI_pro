...
PKG="canvas-storyboard-image-ref-stack-fix-20260604014328"
...
log "verify markers"
grep -Fq "tapnow-rewrite.css?v=20260604-storyboard-image-ref-stack-fix" "$HTML_DEST"
grep -Fq "storyboard-image-ref-area" "$HTML_DEST"
grep -Fq "20260604: storyboard image editor reuses the img2img stacked reference uploader" "$CSS_DEST"
grep -Fq ".node.node-type-storyboardImage .aio-ref-area.vn2-ref-area.prompt-ref-area.storyboard-image-ref-area" "$CSS_DEST"
grep -Fq ".node.node-type-shotStoryboard .shot-storyboard-edit-panel .aio-ref-area.vn2-ref-area.prompt-ref-area.storyboard-image-ref-area" "$CSS_DEST"
