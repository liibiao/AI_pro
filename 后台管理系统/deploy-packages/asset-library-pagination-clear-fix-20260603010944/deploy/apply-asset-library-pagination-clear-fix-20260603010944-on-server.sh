...
PKG="asset-library-pagination-clear-fix-20260603010944"
...
grep -Fq "data-asset-bulk-clear]')?.addEventListener('click',e=>{e.preventDefault();clearSelectedAssets();}" "$DEST"
grep -Fq "CANVAS_ASSET_HIDDEN_KEY" "$DEST"
