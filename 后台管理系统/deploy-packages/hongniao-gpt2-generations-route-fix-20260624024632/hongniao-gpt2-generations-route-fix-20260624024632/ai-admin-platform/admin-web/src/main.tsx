  ...
  return (
    <>
      <div className="formGrid2">
        ...
        <Form.Item name="adapter" label="Adapter" rules={[{ required: true }]}><Input placeholder="openai-image / openai-generations / midjourney-imagine / grok-image / gemini-image-generate / gemini-video / gemini-chat" /></Form.Item>
