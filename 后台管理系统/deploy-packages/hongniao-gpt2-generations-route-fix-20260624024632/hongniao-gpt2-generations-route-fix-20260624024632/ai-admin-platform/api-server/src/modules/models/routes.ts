...
function inferModelType(value: string): ModelType {
  ...
  if (raw.includes('gpt-image') || raw.includes('gpt_image') || raw.includes('image') || raw.includes('img') || raw.includes('imagen') || raw.includes('imagine') || raw.includes('midjourney') || raw.includes('niji') || raw.includes('openai-edits') || raw.includes('openai-generations')) return 'IMAGE';
