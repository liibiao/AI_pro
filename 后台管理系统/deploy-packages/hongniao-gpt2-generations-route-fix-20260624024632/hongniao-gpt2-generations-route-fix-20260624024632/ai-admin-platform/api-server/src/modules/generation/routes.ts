...
function resolveGenerationAdapterName(provider: { adapter?: string | null; providerKey?: string | null; name?: string | null }, model: { adapter?: string | null; name?: string | null; displayName?: string | null; modelKey?: string | null }) {
  ...
  if (configuredLower === 'aiyunzhi-firefly-gpt-image' || configuredLower === 'aiyunzhi-gpt-image-2') return 'aiyunzhi-firefly-gpt-image';
  if (hint.includes('aiyunzhi-firefly-gpt-image') || hint.includes('aiyunzhi-gpt-image-2') || hint.includes('firefly-gpt-image')) return 'aiyunzhi-firefly-gpt-image';
