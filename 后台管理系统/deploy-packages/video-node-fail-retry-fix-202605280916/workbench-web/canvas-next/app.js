...
async function runNode(id){
  ...
  try{
    ...
    const result=n.type==='imageToPanorama'
      ? await runPanorama(n,inputs,state.models,{onProgress:msg=>setProgress(n,msg,token)})
      : await runGenerator(n,inputs,state.models,{onProgress:msg=>setProgress(n,msg,token)});
