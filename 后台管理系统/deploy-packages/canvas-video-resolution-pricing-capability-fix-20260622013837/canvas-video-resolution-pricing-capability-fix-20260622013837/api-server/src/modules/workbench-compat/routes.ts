...
function isCompatGenerationAdapter(adapter: string, type: CompatModelType) {
  ...
  if (type === 'IMAGE') return ['openai-edits', 'openai-responses-image', 'openai-chat-image', 'gpt-image-v2', 'grok_image', 'grok-image-unified', 'grok-image', 'grok-image-edit', 'gemini-image-generate', 'gemini-image-edit'].includes(value);
