...
PKG_NAME="left-toolbar-add-node-entry-20260601170121"
...
grep -q "id=\"toolbarAddNodeBtn\"" "$TARGET"
grep -q "function openToolbarNodePicker" "$TARGET"
grep -q "center:!!opts.center" "$TARGET"
grep -q "openToolbarNodePicker(e?.currentTarget" "$TARGET"
