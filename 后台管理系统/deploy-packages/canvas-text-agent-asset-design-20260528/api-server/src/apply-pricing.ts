...
async function main() {
  ...
  const [imageModels, videoModels, seedanceVipVideoModels, seedanceFastVideoModels, geminiImageModels, gptImage2ProModels, soraVideoModels, soraProVideoModels, soraFastVideoModels, llmModels, gpt54, gpt55, setting, membership] = await prisma.$transaction([
