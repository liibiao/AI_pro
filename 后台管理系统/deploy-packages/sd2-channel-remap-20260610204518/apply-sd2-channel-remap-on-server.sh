...
PKG="sd2-channel-remap-20260610204518"
...
grep -Fq '"url": "https://aiyunzhi.top/v1/videos"' "$WEB_ROOT/tools/workbench-web/models/sd2-full.json"
grep -Fq '"endpointPath": "/videos"' "$WEB_ROOT/tools/workbench-web/models/sd2-full.json"
grep -Fq '"requestSchema": "official-sd2"' "$WEB_ROOT/tools/workbench-web/models/sd2-fast.json"
grep -Fq '"requestSchema": "official-sd2"' "$WEB_ROOT/tools/workbench-web/models/sd2-full.json"
grep -Fq '"model": "seedance-2"' "$WEB_ROOT/tools/workbench-web/models/sd2.json"
grep -Fq '"url": "https://aiyunzhi.top/v1/video/generations"' "$WEB_ROOT/tools/workbench-web/models/sd2.json"
...
echo "SD 2.0 Fast/Full official endpoint: /v1/videos; SD 2.0 seedance endpoint: /v1/video/generations"
