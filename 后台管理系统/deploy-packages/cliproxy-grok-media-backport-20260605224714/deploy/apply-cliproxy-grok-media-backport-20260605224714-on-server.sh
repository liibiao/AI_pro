...
PKG="${1:-/tmp/cliproxy-grok-media-backport-20260605224714.tar.gz}"
PKG_NAME="cliproxy-grok-media-backport-20260605224714"
...
tar -xzf "$PKG" -C "$WORK"
SRC="$WORK/$PKG_NAME"
BIN="$SRC/bin/CLIProxyAPI-grok-media-backport-amd64"
...
log "install CLIProxyAPI binary with Grok media backport"
