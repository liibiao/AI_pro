...
function normalizeImageAspectRatio(value,fallbackSize=''){
  ...
  const direct=['1:1','16:9','9:16','3:2','2:3'].find(item=>item===raw);
...
function imageSizeFromRatioResolution(aspectRatio,resolution,fallbackSize){
  ...
  const supported={
    '1K':{'1:1':'1024x1024','16:9':'1792x1024','9:16':'1024x1792','3:2':'1536x1024','2:3':'1024x1536'}
  };
...
function normalizeSupportedGrokImageSize(value){
  const raw=String(value||'').trim().toLowerCase().replace('×','x');
  if(['1024x1024','1792x1024','1024x1792','1536x1024','1024x1536','1280x720','720x1280'].includes(raw))return raw;
