...
PKG="video-resolution-disable-config-20260603122150"
...
grep -Fq "disabledResolutions=normalizeVideoDisabledResolutionList" "$SRC/workbench-web/image-studio-canvas-next.html"
...
run_sudo grep -Fq "disabledResolutions=normalizeVideoDisabledResolutionList" "$WORKBENCH_DIR/image-studio-canvas-next.html"
