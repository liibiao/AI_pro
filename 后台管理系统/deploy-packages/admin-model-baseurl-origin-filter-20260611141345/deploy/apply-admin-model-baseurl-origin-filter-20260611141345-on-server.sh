...
PKG="admin-model-baseurl-origin-filter-20260611141345"
...
grep -Fq "return url.origin;" "$SRC/src/main.tsx"
grep -Fq "raw.replace(/^(https?:\/\/[^/]+).*/i," "$SRC/src/main.tsx"
...
run_sudo grep -Fq "return url.origin;" "$REMOTE_APP_ROOT/admin-web/src/main.tsx"
