...
WORK_ROOT="/tmp/image-ratio-full-chain-fix-$$"
BACKUP_ROOT="/var/www/ai-admin/backups/image-ratio-full-chain-fix-$(date +%Y%m%d%H%M%S)"
...
echo "image ratio full-chain fix installed"
