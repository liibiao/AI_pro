...
PKG="${1:-/tmp/cliproxy-official-latest-20260605132128.tar.gz}"
PKG_NAME="cliproxy-official-latest-20260605132128"
...
tar -xzf "$PKG" -C "$WORK"
SRC="$WORK/$PKG_NAME"
BIN="$SRC/bin/CLIProxyAPI-official-latest-amd64"
...
log "install latest CLIProxyAPI binary"
...
deploy_with_docker() {
  ...
  log "recreate $SERVICE_NAME container with latest binary"
