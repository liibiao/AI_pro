...
function normalizeEndpointConfig(config: CanvasModelConfig, modelType: SyncedModelType) {
  ...
  const fallbackEndpoint = adapter === 'seedance-task'
    ...
    : adapter === 'sora-video' || adapter === 'sora-video-pro'
    ? '/videos'
