...
PKG="canvas-text-prompt-asset-derive-panel-20260604115357"
...
grep -q "asset-card-derive-float" /var/www/ai-admin/workbench-web/image-studio-canvas-next.html
grep -q "data-asset-card-field=\"templateId\"" /var/www/ai-admin/workbench-web/image-studio-canvas-next.html
grep -q "data-asset-card-field=\"resolution\"" /var/www/ai-admin/workbench-web/image-studio-canvas-next.html
grep -q "data-asset-card-field=\"modelKey\"" /var/www/ai-admin/workbench-web/image-studio-canvas-next.html
grep -q "asset-card-derive-float" /var/www/ai-admin/workbench-web/canvas-next/tapnow-rewrite.css
