...
PKG="admin-model-baseurl-link-20260611155920"
...
grep -Fq "selectedBaseUrl" "$SRC/src/main.tsx"
grep -Fq "selectedBaseUrlLinkBar" "$SRC/src/main.tsx"
grep -Fq "target=\"_blank\"" "$SRC/src/main.tsx"
grep -Fq ".selectedBaseUrlLinkBar" "$SRC/src/styles.css"
grep -Rqs "按渠道 Base URL 筛选" "$SRC/dist"
grep -Rqs "selectedBaseUrlLinkBar" "$SRC/dist"
...
run_sudo grep -Fq "selectedBaseUrlLinkBar" "$REMOTE_APP_ROOT/admin-web/src/main.tsx"
run_sudo grep -Fq "target=\"_blank\"" "$REMOTE_APP_ROOT/admin-web/src/main.tsx"
run_sudo grep -Fq ".selectedBaseUrlLinkBar" "$REMOTE_APP_ROOT/admin-web/src/styles.css"
run_sudo grep -Rqs "selectedBaseUrlLinkBar" "$REMOTE_APP_ROOT/admin-web/dist"
