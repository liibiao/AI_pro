...
function isStoryboardModeQuery(mode: string) {
  ...
  return matchesStoryboardText(text) && !isAssetDesignModeQuery(text) && !isShotStoryboardModeQuery(text);
}

function isAssetDesignModeQuery(mode: string) {
  return matchesAssetDesignText(String(mode || ''));
}

function isShotStoryboardModeQuery(mode: string) {
  return matchesShotStoryboardText(String(mode || ''));
}
...
function generationTaskPromptText(task: { prompt?: unknown }) {
