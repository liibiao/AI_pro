...
type ImageResponseType = 'object_storage' | 'server_object_storage' | 'server_base64_object_storage' | 'provider_url' | 'base64';
...
function openAiImageResponseFormat(ctx: AdapterContext) {
  ...
  if (responseType === 'base64' || responseType === 'server_base64_object_storage') return 'b64_json';
