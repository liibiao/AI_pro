...
PKG="${1:-/tmp/asset-design-template-cos-final-20260602022408.tar.gz}"
...
WORK="$(mktemp -d /tmp/asset-design-template-cos-final-20260602022408-XXXXXX)"
BACKUP="/var/www/ai-admin/backups/asset-design-template-cos-final-20260602022408-$STAMP"
...
tar -xzf "$PKG" -C "$WORK"
SRC="$WORK/asset-design-template-cos-final-20260602022408"
