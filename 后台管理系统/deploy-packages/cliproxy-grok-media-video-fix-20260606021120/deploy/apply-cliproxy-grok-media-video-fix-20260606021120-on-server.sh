...
PKG="${1:-/tmp/cliproxy-grok-media-video-fix-20260606021120.tar.gz}"
PKG_NAME="cliproxy-grok-media-video-fix-20260606021120"
...
tar -xzf "$PKG" -C "$WORK"
SRC="$WORK/$PKG_NAME"
BIN="$SRC/bin/CLIProxyAPI-grok-media-video-fix-amd64"
...
log "install CLIProxyAPI binary with Grok media video fix"
