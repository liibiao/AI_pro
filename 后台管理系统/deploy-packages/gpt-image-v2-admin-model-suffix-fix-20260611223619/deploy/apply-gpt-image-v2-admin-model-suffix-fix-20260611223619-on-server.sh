...
PKG="gpt-image-v2-admin-model-suffix-fix-20260611223619"
...
grep -Fq "resolveGptImageV2ModelName" "$REG_SRC"
grep -Fq "normalizeGptImageV2Resolution" "$REG_SRC"
grep -Fq "model: requestModel" "$REG_SRC"
grep -Fq "resolveGptImageV2ModelName" "$REG_DIST"
grep -Fq "normalizeGptImageV2Resolution" "$REG_DIST"
grep -Fq "model: requestModel" "$REG_DIST"
...
run_sudo grep -Fq "resolveGptImageV2ModelName" "$APP_DIR/api-server/src/modules/generation/adapters/registry.ts"
run_sudo grep -Fq "normalizeGptImageV2Resolution" "$APP_DIR/api-server/dist/modules/generation/adapters/registry.js"
run_sudo grep -Fq "model: requestModel" "$APP_DIR/api-server/dist/modules/generation/adapters/registry.js"
