...
function isCompatGenerationAdapter(adapter: string, type: CompatModelType) {
  ...
  if (type === 'VIDEO') return ['sora-video', 'sora-video-pro', 'seedance-task', 'seedance2', 'seedance2.0', 'seedance2-sd', 'sd-seedance2', 'sd-video', 'seedance2-vip', 'seedance2.0-vip', 'notevideo', 'grok-video', 'gemini-video', 'veo-video'].includes(value);
  return false;
}
