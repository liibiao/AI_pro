...
PKG="${1:-/tmp/llm-chat-debug-page-20260531.tar.gz}"
APP_DIR="${APP_DIR:-/var/www/ai-admin/ai-admin-platform}"
PM2_APP="${PM2_APP:-ai-admin-api}"
PM2_USER="${PM2_USER:-ubuntu}"
STAMP="$(date +%Y%m%d%H%M%S)"
WORK="$(mktemp -d /tmp/llm-chat-debug-page-20260531-XXXXXX)"
...
tar -xzf "$PKG" -C "$WORK"
SRC="$WORK/llm-chat-debug-page-20260531"
...
BACKUP_ROOT="/var/www/ai-admin/backups/llm-chat-debug-page-20260531-$STAMP"
