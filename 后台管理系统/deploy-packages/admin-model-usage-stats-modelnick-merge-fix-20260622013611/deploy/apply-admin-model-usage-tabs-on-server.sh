...
grep -Fq "STRING_AGG(DISTINCT NULLIF(BTRIM(gt.\"channel_key\"), '')" "$API_SRC"
grep -Fq "modelDisplayName" "$API_SRC"
grep -Fq "generationTaskUsageStatsPeriodFilter" "$API_SRC"
...
grep -Fq "STRING_AGG(DISTINCT NULLIF(BTRIM(gt.\"channel_key\"), '')" "$API_DIST"
grep -Fq "modelDisplayName" "$API_DIST"
grep -Fq "generationTaskUsageStatsPeriodFilter" "$API_DIST"
...
run_sudo grep -Fq "STRING_AGG(DISTINCT NULLIF(BTRIM(gt.\"channel_key\"), '')" "$REMOTE_APP_ROOT/api-server/src/modules/models/routes.ts"
run_sudo grep -Fq "modelDisplayName" "$REMOTE_APP_ROOT/api-server/src/modules/models/routes.ts"
run_sudo grep -Fq "generationTaskUsageStatsPeriodFilter" "$REMOTE_APP_ROOT/api-server/src/modules/models/routes.ts"
...
run_sudo grep -Fq "STRING_AGG(DISTINCT NULLIF(BTRIM(gt.\"channel_key\"), '')" "$REMOTE_APP_ROOT/api-server/dist/modules/models/routes.js"
run_sudo grep -Fq "modelDisplayName" "$REMOTE_APP_ROOT/api-server/dist/modules/models/routes.js"
run_sudo grep -Fq "generationTaskUsageStatsPeriodFilter" "$REMOTE_APP_ROOT/api-server/dist/modules/models/routes.js"
