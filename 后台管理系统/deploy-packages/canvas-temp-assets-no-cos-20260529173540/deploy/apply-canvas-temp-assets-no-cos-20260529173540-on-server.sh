...
PKG="${PKG:-/tmp/canvas-temp-assets-no-cos-20260529173540.tar.gz}"
...
BACKUP="${BACKUP:-/var/www/ai-admin/backups/canvas-temp-assets-no-cos-20260529173540-$STAMP}"
TMP="$(mktemp -d /tmp/canvas-temp-assets-no-cos-20260529173540.XXXXXX)"
...
grep -q "canvas-temp" "$WORKBENCH_DIR/image-studio-canvas-next.html"
