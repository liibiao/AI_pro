...
PKG="${1:-/tmp/asset-design-template-cos-final-20260602141923.tar.gz}"
...
WORK="$(mktemp -d /tmp/asset-design-template-cos-final-20260602141923-XXXXXX)"
BACKUP="/var/www/ai-admin/backups/asset-design-template-cos-final-20260602141923-$STAMP"
...
tar -xzf "$PKG" -C "$WORK"
SRC="$WORK/asset-design-template-cos-final-20260602141923"
