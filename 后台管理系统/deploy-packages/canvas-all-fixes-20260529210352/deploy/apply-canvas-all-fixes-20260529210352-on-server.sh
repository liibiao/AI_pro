...
PKG="${PKG:-/tmp/canvas-all-fixes-20260529210352.tar.gz}"
...
BACKUP="${BACKUP:-/var/www/ai-admin/backups/canvas-all-fixes-20260529210352-$STAMP}"
TMP="$(mktemp -d /tmp/canvas-all-fixes-20260529210352.XXXXXX)"
