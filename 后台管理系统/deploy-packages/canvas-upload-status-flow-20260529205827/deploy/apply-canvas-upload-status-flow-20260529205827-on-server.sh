...
PKG="${PKG:-/tmp/canvas-upload-status-flow-20260529205827.tar.gz}"
...
BACKUP="${BACKUP:-/var/www/ai-admin/backups/canvas-upload-status-flow-20260529205827-$STAMP}"
TMP="$(mktemp -d /tmp/canvas-upload-status-flow-20260529205827.XXXXXX)"
