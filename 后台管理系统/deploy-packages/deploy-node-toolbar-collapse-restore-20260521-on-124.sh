...
PKG="${1:-/tmp/node-toolbar-collapse-restore-20260521.tar.gz}"
...
WORKDIR="$(mktemp -d /tmp/node-toolbar-collapse-restore-XXXXXX)"
...
echo "部署完成：节点工具栏已恢复为原来的图标模式，仅保留画布顶部和左侧工具栏 hover 展开。"
