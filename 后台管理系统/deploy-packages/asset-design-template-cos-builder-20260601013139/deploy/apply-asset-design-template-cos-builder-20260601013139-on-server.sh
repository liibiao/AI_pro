...
PKG="${1:-/tmp/asset-design-template-cos-builder-20260601013139.tar.gz}"
...
WORK="$(mktemp -d /tmp/asset-design-template-cos-builder-20260601013139-XXXXXX)"
BACKUP="/var/www/ai-admin/backups/asset-design-template-cos-builder-20260601013139-$STAMP"
...
tar -xzf "$PKG" -C "$WORK"
SRC="$WORK/asset-design-template-cos-builder-20260601013139"
