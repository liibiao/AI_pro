...
PKG="canvas-storyboard-selection-ui-fix-20260604003137"
...
log "verify markers"
grep -Fq "storygrid-panel.active::after" "$HTML_DEST"
grep -Fq "storygrid-cell.active::after" "$HTML_DEST"
grep -Fq "storygrid-shot-btn.active" "$HTML_DEST"
