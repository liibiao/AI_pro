...
PKG_LABEL="admin-generation-report-page-scope"
ARCHIVE="${1:-}"
...
grep -Fq "adminGenerationResultPageParams" "$API_SRC"
grep -Fq "findAdminGenerationReportTasks" "$API_SRC"
grep -Fq "scope: 'page'" "$API_SRC"
...
grep -Fq "adminGenerationResultPageParams" "$API_DIST"
grep -Fq "findAdminGenerationReportTasks" "$API_DIST"
grep -Fq "scope: 'page'" "$API_DIST"
...
run_sudo grep -Fq "adminGenerationResultPageParams" "$REMOTE_APP_ROOT/api-server/src/modules/generation/routes.ts"
run_sudo grep -Fq "findAdminGenerationReportTasks" "$REMOTE_APP_ROOT/api-server/src/modules/generation/routes.ts"
run_sudo grep -Fq "scope: 'page'" "$REMOTE_APP_ROOT/api-server/src/modules/generation/routes.ts"
...
run_sudo grep -Fq "adminGenerationResultPageParams" "$REMOTE_APP_ROOT/api-server/dist/modules/generation/routes.js"
run_sudo grep -Fq "findAdminGenerationReportTasks" "$REMOTE_APP_ROOT/api-server/dist/modules/generation/routes.js"
run_sudo grep -Fq "scope: 'page'" "$REMOTE_APP_ROOT/api-server/dist/modules/generation/routes.js"
...
run_sudo grep -Fq "当前页数据概览" "$REMOTE_APP_ROOT/admin-web/src/main.tsx"
...
run_sudo grep -Rqs "当前页数据概览" "$REMOTE_APP_ROOT/admin-web/dist"
