...
async function main() {
  ...
  for (const provider of targetProviders) {
    ...
    console.log(`[fix] provider ${provider.providerKey} -> gpt-image-v2 /v1/images/generations object_storage`);
  }
  ...
  for (const model of targetModels.values()) {
    ...
    console.log(`[fix] model ${model.id}/${model.displayName} -> gpt-image-2 gpt-image-v2 /v1/images/generations object_storage`);
  }
