...
PKG="canvas-storyboard-image-editor-refresh-progress-fix-20260603233756"
...
grep -Fq "loadedGraphReferenceSignature" "$HTML_DEST"
grep -Fq "shot-row-table-dialog" "$HTML_DEST"
grep -Fq "shotTableEditorModel" "$HTML_DEST"
grep -Fq "storygrid-shot-progress" "$HTML_DEST"
grep -Fq "cloneStoryboardUploadEntry" "$HTML_DEST"
