...
PKG="canvas-pano-toolbar-center-shot-menu-fix-20260604003420"
...
log "verify markers"
grep -Fq "tapnow-rewrite.css?v=20260604-pano-toolbar-center-shot-menu-fix" "$HTML_DEST"
grep -Fq "simple centered panorama toolbar layout" "$CSS_DEST"
...
grep -Fq "stage.classList.contains('pano-drag-button-active')" "$HTML_DEST"
