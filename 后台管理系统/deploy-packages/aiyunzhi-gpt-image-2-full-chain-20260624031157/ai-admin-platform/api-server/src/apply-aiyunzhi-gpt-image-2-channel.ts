...
const providerId = 'canvas-provider-aiyunzhi-gpt-image-2';
const providerKey = 'canvas_aiyunzhi-gpt-image-2';
const modelId = 'canvas-aiyunzhi-gpt-image-2';
const modelKey = 'aiyunzhi-gpt-image-2';
const displayName = 'Aiyunzhi GPT Image 2';
