...
export type UserClientType = 'ADMIN_WEB' | 'CANVAS';

export type UserTokenPayload = { id: string; role: UserRole; nickname: string; status: string; sessionId?: string; clientType?: UserClientType };
