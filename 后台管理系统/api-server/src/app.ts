...
import workbenchTextAgentRoutes from './modules/workbench/text-agent-routes.js';
import workbenchAssetDesignRoutes from './modules/workbench/asset-design-routes.js';
import dataPackRoutes from './modules/data-packs/routes.js';
import canvasNodeConfigRoutes from './modules/canvas-node-config/routes.js';
...
app.use(cors({
  origin(origin, callback) {
    ...
    if (!origin || isLocalFileOrigin || isLocalCanvasOrigin || config.corsOrigins.includes('*') || config.corsOrigins.includes(origin)) {
      callback(null, true);
      return;
    }
    callback(null, false);
...
app.use('/api', workbenchTextAgentRoutes);
app.use('/api', workbenchAssetDesignRoutes);
app.use('/api', dataPackRoutes);
app.use('/api', canvasNodeConfigRoutes);
